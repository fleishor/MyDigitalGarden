...
In .NET projects, Directory.Build.props is a special MSBuild file that allows you to define project properties and settings that apply to all projects within a directory and its subdirectories.
