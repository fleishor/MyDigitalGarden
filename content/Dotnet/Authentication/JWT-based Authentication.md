...
- [JWT Authentication with Symmetric Encryption in ASP.NET Core](https://dev.to/eduardstefanescu/jwt-authentication-with-symmetric-encryption-in-asp-net-core-2i53)
